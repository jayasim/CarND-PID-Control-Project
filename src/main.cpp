...
int main()
{
  ...
  // TODO: Initialize the pid variable - Manual
  //pid.Init(0.03, 0.5, 0.10); // Kp, Ki, Kd
  ...
  pid_s.Init(0.134611, 0.000270736, 3.05349); // steering angles
  pid_t.Init(0.316731, 0.0000, 0.0226185); // throttle
